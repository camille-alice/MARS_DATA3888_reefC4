...
```{r}
save(cv_50acc5_bin, cv_50acc5_sel, cv_acc50_NB, cv_acc50_knn, cv_acc50_rf, cv_acc50_svm, 
     bin_cf, bin_sel_cf, nb_cf, knn_cf, rf_cf, svm_cf, 
     bin_mean, sel_mean, nb_mean, knn_mean, rf_mean, svm_mean,
     bin_sd, sel_sd, nb_sd, knn_sd, rf_sd, svm_sd,
